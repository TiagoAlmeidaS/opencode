...
Funcionalidades e capacidades do produto: especificação, configuração, status e prioridade (plugins, integrações, pipelines).

| Documento | Descrição |
|-----------|-----------|
| [plugins-telegram-whatsapp.md](plugins-telegram-whatsapp.md) | Plugins Telegram e WhatsApp: ferramentas de envio, daily notifier. |
