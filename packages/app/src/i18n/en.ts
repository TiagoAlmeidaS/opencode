export const dict = {
  ...
  "command.project.addRepository": "Add repository",
  ...
  "command.discovery.analyze": "Analyze project idea",
  "command.discovery.analyze.description": "Fill the prompt with /project-discovery to analyze a project or venture idea",
  ...
  "dialog.addRepository.title": "Add repository",
  "dialog.addRepository.urlLabel": "Repository URL",
  "dialog.addRepository.branchLabel": "Branch (optional)",
  "dialog.addRepository.branchPlaceholder": "default branch",
  "dialog.addRepository.submit": "Add",
  "dialog.addRepository.error.urlRequired": "URL is required",
  "dialog.addRepository.error.githubOnly": "Only GitHub URLs are allowed",
  "dialog.addRepository.error.urlInvalid": "Invalid URL",
  "dialog.addRepository.toast.title": "Repository added",
  "dialog.addRepository.toast.errorTitle": "Failed to add repository",
  ...
  "dialog.spec.title.create": "New Spec",
  "dialog.spec.title.edit": "Edit Spec",
  "dialog.spec.section.basic": "Basic",
  "dialog.spec.section.ontology": "Ontology",
  "dialog.spec.section.contracts": "Contracts",
  "dialog.spec.section.rules": "Rules",
  "dialog.spec.section.architecture": "Architecture",
  "dialog.spec.section.context": "Context",
  "dialog.spec.field.name": "Name",
  "dialog.spec.field.description": "Description",
  "dialog.spec.field.context": "Business Context",
  "dialog.spec.field.ontology": "Ontology Entries",
  "dialog.spec.field.term": "Term",
  "dialog.spec.field.definition": "Definition",
  "dialog.spec.field.canonicalName": "Canonical name",
  "dialog.spec.field.contracts": "TypeScript Interfaces",
  "dialog.spec.field.rules": "Constraint Rules",
  "dialog.spec.field.rule": "Rule",
  "dialog.spec.field.reason": "Reason",
  "dialog.spec.field.architecture": "Architecture Diagram (Mermaid)",
  "dialog.spec.action.addOntologyEntry": "+ Add term",
  "dialog.spec.action.addConstraint": "+ Add rule",
  "dialog.spec.action.save": "Save",
  "dialog.spec.action.saving": "Saving…",
  "dialog.spec.action.cancel": "Cancel",
  "dialog.spec.placeholder.name": "e.g. My SaaS Domain",
  "dialog.spec.placeholder.description": "Short description of this spec",
  "dialog.spec.placeholder.context": "Background business context, goals, target users…",
  "dialog.spec.placeholder.contracts": "interface MyEntity {\n  id: string\n  …\n}",
  "dialog.spec.placeholder.architecture": "graph TD\n  A[Client] --> B[API]\n  B --> C[DB]",
  "board.specs.table.name": "Name",
  "board.specs.table.description": "Description",
  "board.specs.table.created": "Created",
  "board.specs.action.preview": "Preview",
  "board.specs.action.edit": "Edit",
  "board.specs.action.delete": "Delete",
  "board.specs.action.newSpec": "+ New Spec",
  "board.specs.preview.title": "Compiled Prompt",
  "board.specs.empty": "No specs yet. Create one to provide domain context to AI pipelines.",

  "schedules.title": "Schedules",
  "schedules.loading": "Loading…",
  "schedules.empty": "No pipelines configured yet.",
  "schedules.action.refresh": "Refresh",
  "schedules.action.new": "+ New Pipeline",
  "schedules.action.run": "Run now",
  "schedules.action.running": "Running…",
  "schedules.action.enable": "Enable pipeline",
  "schedules.action.disable": "Disable pipeline",
  "schedules.action.showJobs": "Jobs",
  "schedules.action.hideJobs": "Hide",
  "schedules.form.title": "New Pipeline",
  "schedules.form.name.placeholder": "Pipeline name",
  "schedules.form.strategy.placeholder": "Select strategy…",
  "schedules.form.error.name": "Name is required",
  "schedules.form.error.strategy": "Strategy is required",
  "schedules.form.action.save": "Create",
  "schedules.form.action.saving": "Creating…",
  "schedules.form.action.cancel": "Cancel",
  "schedules.jobs.title": "Recent Jobs",
  "schedules.jobs.loading": "Loading jobs…",
  "schedules.jobs.empty": "No jobs yet for this pipeline.",
}
