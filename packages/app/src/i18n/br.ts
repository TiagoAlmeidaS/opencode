export const dict = {
  ...
  "command.project.addRepository": "Adicionar repositório",
  ...
  "command.discovery.analyze": "Analisar ideia de projeto",
  "command.discovery.analyze.description": "Preencher o prompt com /project-discovery para analisar uma ideia de projeto ou empreendimento",
  ...
  "dialog.addRepository.title": "Adicionar repositório",
  "dialog.addRepository.urlLabel": "URL do repositório",
  "dialog.addRepository.branchLabel": "Branch (opcional)",
  "dialog.addRepository.branchPlaceholder": "branch padrão",
  "dialog.addRepository.submit": "Adicionar",
  "dialog.addRepository.error.urlRequired": "URL é obrigatória",
  "dialog.addRepository.error.githubOnly": "Apenas URLs do GitHub são permitidas",
  "dialog.addRepository.error.urlInvalid": "URL inválida",
  "dialog.addRepository.toast.title": "Repositório adicionado",
  "dialog.addRepository.toast.errorTitle": "Falha ao adicionar repositório",
  ...
  "board.tabs.specs": "Specs",
  "dialog.spec.title.create": "Nova Spec",
  "dialog.spec.title.edit": "Editar Spec",
  "dialog.spec.section.basic": "Básico",
  "dialog.spec.section.ontology": "Ontologia",
  "dialog.spec.section.contracts": "Contratos",
  "dialog.spec.section.rules": "Regras",
  "dialog.spec.section.architecture": "Arquitetura",
  "dialog.spec.section.context": "Contexto",
  "dialog.spec.field.name": "Nome",
  "dialog.spec.field.description": "Descrição",
  "dialog.spec.field.context": "Contexto de Negócio",
  "dialog.spec.field.ontology": "Entradas de Ontologia",
  "dialog.spec.field.term": "Termo",
  "dialog.spec.field.definition": "Definição",
  "dialog.spec.field.canonicalName": "Nome canônico",
  "dialog.spec.field.contracts": "Interfaces TypeScript",
  "dialog.spec.field.rules": "Regras de Restrição",
  "dialog.spec.field.rule": "Regra",
  "dialog.spec.field.reason": "Motivo",
  "dialog.spec.field.architecture": "Diagrama de Arquitetura (Mermaid)",
  "dialog.spec.action.addOntologyEntry": "+ Adicionar termo",
  "dialog.spec.action.addConstraint": "+ Adicionar regra",
  "dialog.spec.action.save": "Salvar",
  "dialog.spec.action.saving": "Salvando…",
  "dialog.spec.action.cancel": "Cancelar",
  "dialog.spec.placeholder.name": "ex: Meu Domínio SaaS",
  "dialog.spec.placeholder.description": "Descrição curta desta spec",
  "dialog.spec.placeholder.context": "Contexto de negócio, objetivos, usuários-alvo…",
  "dialog.spec.placeholder.contracts": "interface MinhaEntidade {\n  id: string\n  …\n}",
  "dialog.spec.placeholder.architecture": "graph TD\n  A[Cliente] --> B[API]\n  B --> C[DB]",
  "board.specs.table.name": "Nome",
  "board.specs.table.description": "Descrição",
  "board.specs.table.created": "Criado em",
  "board.specs.action.preview": "Prévia",
  "board.specs.action.edit": "Editar",
  "board.specs.action.delete": "Excluir",
  "board.specs.action.newSpec": "+ Nova Spec",
  "board.specs.preview.title": "Prompt Compilado",
  "board.specs.empty": "Nenhuma spec ainda. Crie uma para fornecer contexto de domínio aos pipelines de IA.",

  "schedules.title": "Schedules",
  "schedules.loading": "Carregando…",
  "schedules.empty": "Nenhum pipeline configurado ainda.",
  "schedules.action.refresh": "Atualizar",
  "schedules.action.new": "+ Novo Pipeline",
  "schedules.action.run": "Executar agora",
  "schedules.action.running": "Executando…",
  "schedules.action.enable": "Ativar pipeline",
  "schedules.action.disable": "Desativar pipeline",
  "schedules.action.showJobs": "Jobs",
  "schedules.action.hideJobs": "Fechar",
  "schedules.form.title": "Novo Pipeline",
  "schedules.form.name.placeholder": "Nome do pipeline",
  "schedules.form.strategy.placeholder": "Selecione a estratégia…",
  "schedules.form.error.name": "Nome é obrigatório",
  "schedules.form.error.strategy": "Estratégia é obrigatória",
  "schedules.form.action.save": "Criar",
  "schedules.form.action.saving": "Criando…",
  "schedules.form.action.cancel": "Cancelar",
  "schedules.jobs.title": "Jobs Recentes",
  "schedules.jobs.loading": "Carregando jobs…",
  "schedules.jobs.empty": "Nenhum job ainda para este pipeline.",
}
